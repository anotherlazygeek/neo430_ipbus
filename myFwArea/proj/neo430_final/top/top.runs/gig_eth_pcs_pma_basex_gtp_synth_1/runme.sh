...
HD_PWD='/usersc/ng18731/ATFC_IPBus_neo_test/neo430_test/myFwArea/proj/neo430_final/top/top.runs/gig_eth_pcs_pma_basex_gtp_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gig_eth_pcs_pma_basex_gtp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gig_eth_pcs_pma_basex_gtp.tcl
