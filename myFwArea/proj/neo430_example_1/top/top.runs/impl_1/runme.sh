...
HD_PWD='/usersc/ng18731/ATFC_IPBus_neo_test/neo430_test/myFwArea/proj/neo430_example_1/top/top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log neo430_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source neo430_test.tcl -notrace
