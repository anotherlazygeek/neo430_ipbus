...
HD_PWD='/usersc/ng18731/ATFC_IPBus_neo_test/neo430_test/myFwArea/proj/neo430_example_1/top/top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neo430_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neo430_test.tcl
