...
package ipbus_decode_tb_tx is

  constant IPBUS_SEL_WIDTH: positive := 5; -- Should be enough for now?
  subtype ipbus_sel_t is std_logic_vector(IPBUS_SEL_WIDTH - 1 downto 0);
  function ipbus_sel_tb_tx(addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t;
...
end ipbus_decode_tb_tx;

package body ipbus_decode_tb_tx is

  function ipbus_sel_tb_tx(addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t is
