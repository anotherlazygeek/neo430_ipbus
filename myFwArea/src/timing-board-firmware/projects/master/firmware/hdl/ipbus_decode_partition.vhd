...
package ipbus_decode_partition is

  constant IPBUS_SEL_WIDTH: positive := 5; -- Should be enough for now?
  subtype ipbus_sel_t is std_logic_vector(IPBUS_SEL_WIDTH - 1 downto 0);
  function ipbus_sel_partition(addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t;

-- START automatically  generated VHDL the Sat May  6 19:50:56 2017 
...
end ipbus_decode_partition;

package body ipbus_decode_partition is

  function ipbus_sel_partition(addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t is
...
-- END automatically generated VHDL
  ...
  end function ipbus_sel_partition;
