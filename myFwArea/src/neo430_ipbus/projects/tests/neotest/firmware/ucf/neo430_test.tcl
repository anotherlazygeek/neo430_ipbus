...
#create_clock -period 10.000 -name clk_sysclk [get_ports sysclk]

#set_property PACKAGE_PIN D17 [get_ports sysclk]
...
#set_property PACKAGE_PIN Y2 [get_ports {rst_i}]
#false_path rst_* eth_refclk
...
#set_property PACKAGE_PIN C20 [get_ports {uart_rxd_i}]
#false_path uart_* eth_refclk

#set_property IOSTANDARD LVCMOS33 [get_ports {uid_sda}]
#set_property PACKAGE_PIN AB22 [get_ports {uid_sda}]
#set_property IOSTANDARD LVCMOS33 [get_ports {uid_scl}]
